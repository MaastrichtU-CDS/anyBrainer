...
def test_visualize_mae_transforms():
    ...
    transforms = Compose(mae_settings["settings"]["transforms"]).set_random_state(
        seed=mae_settings["settings"]["master_seed"]
    )
...
def test_visualize_predict_transforms():
    """Visualize the reference transforms."""
    transforms = Compose(predict_settings["settings"]["transforms"]).set_random_state(
        seed=predict_settings["settings"]["master_seed"]
    )
